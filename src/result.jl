...
function MapfResult(
    ...
    return MapfResult{T}(network, paths, stay_after_arrival)
end
...
function agent_location(res::MapfResult, t::Float64)::Vector{GraphLocation}
    return agent_location.(res.paths, t; stay_after_arrival=res.stay_after_arrival)
end
